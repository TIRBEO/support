...
var TirbeoThemeContext = createContext(void 0);
var CSS_VARIABLES = {
...
function setAdminThemeVars(root, isDark) {
  const vars = [
...
function TirbeoThemeProvider({
  ...
  return /* @__PURE__ */ jsx(TirbeoThemeContext.Provider, { value: { mode, density, setMode, setDensity }, children });
}
function useTirbeoTheme() {
